...
if __name__ == '__main__':
	isotherm_by_inner(range(500, 7000, 10), '../data/isotherm_by_inner') #TODO: Steps
	isotherm_by_radii(range(3, 50, 1), '../data/isotherm_by_radii')
